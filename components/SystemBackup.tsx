...
import { DownloadCloud, UploadCloud, AlertCircle, RefreshCw, CheckCircle2 } from 'lucide-react';
        ...
        <div className="max-w-4xl space-y-8 animate-in fade-in duration-500">
            <div>
                ...
                <p className="mt-2 text-sm text-gray-500">
                    Manage system snapshots and restore operations from backups.
                </p>
            </div>
            ...
            {restoreMessage && (
                <div className={`p-4 rounded-lg flex items-start gap-3 border ${restoreMessage.type === 'success' ? 'bg-emerald-50 border-emerald-200 text-emerald-800' : 'bg-rose-50 border-rose-200 text-rose-800'
                    }`}>
